...
function fonc1()
{
window.location.href ='p_admin_suppression_de_fichiers.asp'
}
function fonc2()
{
window.location.href ='p_admin_suppression_de_fichiers_autres.asp'
}
...
<table border="0px" width="100%" cellpadding="10px">
	...
	<tr>
    	<td colspan="2"><font color="#6faa06">Menu Suppression sur le Serveur _______________________________________________________________</font></td>
    </tr>
...
<table bgcolor="#6faa06"  cellspacing="1" cellpadding="5" border="0" align="center" style="WIDTH: 409px; HEIGHT: 102px">
  ...
  <TR>
		<td align="middle" bgcolor="white">
			...
			<tr>
				<td align="middle"><div class=alien name="actualites ndambog"  title="Actualités de ndambog"    
            onclick="return fonc1()">
				Suppression des fichiers "OLD"</div>
				</td>
			</tr>		
			</table>
		</td><!--</tr>
		...
		<td align="middle" bgcolor="white">
			...
			<tr>
				<td align="middle"><div class=alien name="Modifier actu ndambog"  title="Modifier actu Ndambog" onclick="return fonc2()">
					...
					Suppression des fichiers "ANCIEN"
					</div>
				</td>
			</tr>		
			</table>
