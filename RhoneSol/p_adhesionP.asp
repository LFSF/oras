...
<tr>
<td colspan="2"><font color="#6FAA06">Adhésion partenaire___________________________________________________________</font></td>
</tr>
</table>
...
<form action="verif_p_adhesionP.asp" method="post" id="contact" name="contact" onsubmit="return verifformP()">
