        ...
        <tr valign="top"> 
          ...
          %>
              ...
              <tr bgcolor="<%=strBgcolor%>"> 
                ...
                <td width="20"><a href="p_admin_interview_view_delete.asp?idint=<%=rsED("NumItw")%>"><img src="img racine/postedit.gif" border="0"></a></td>
              </tr>
        ...
        <tr valign="top"> 
          ...
          %>
              ...
              <tr bgcolor="<%=strBgcolor%>"> 
                ...
                <td width="20"><a href="p_admin_interview_view_delete.asp?idint=<%=rsED1("NumItw")%>"><img src="img racine/postedit.gif" border="0"></a></td>
              </tr>
