...
if rsED1.EOF then
    ...
    %>
                <tr bgcolor="<%=strBgcolor%>"> 
                    ...
                    <td width="20"><a href="p_admin_cv_display.asp?num=<%=rsED1("NumCV")%>"><img src="img/postdisplay.gif" border="0"></a></td>
...
%>
            <tr bgcolor="<%=strBgcolor%>"> 
                ...
                <td width="20"><a href="p_admin_cv_display.asp?num=<%=rsEDcv1("NumCV")%>"><img src="img/postdisplay.gif" border="0"></a></td>
