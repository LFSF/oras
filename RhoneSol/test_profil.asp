...
//vérifie si la confirmation est bien indiqué 
 else if (document.contact.MdpProfil2.value == "")
 {
 alert("\nMerci de confirmer votre mot de passe.");
 document.contact.MdpProfil2.focus();
 return false;
 }
...
//Met le mdp dans une variable   
 if(document.contact.MdpProfil.value != "")
 {
 pw1=document.contact.MdpProfil.value;
 }

//met la confirmation dans une variable
 if(document.contact.MdpProfil2.value !="")
 {
 pw2=document.contact.MdpProfil2.value;
 }
...
<div id="bandeau_menu"><!-- #include file ="test_menu_deroulant.asp" --><br />
	...
	<table width="583" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="439" align="top" class="txt">
...
<!-- Formulaire d'adhésion -->
					...
					<form action="valider_profil_modif.asp" method="post" id="profil" name="profil" onsubmit="return verifform()">
						...
						<table border="0" width="100%" cellpadding="2" cellspacing="0" class="txt">
							<tr>
								<td class="textes">Raison social</td>
...
<!--vérifie si les donnée inscrite sont bien des chiffres, keycode pour IE et which pour firefox-->
							...
							<tr>
								<td class="textes">Ancien Mot de passe *</td>
							...
							<tr>
								...
								<td><input type="password" name="MdpProfil2" class="txt" size="30" maxlength="50" /></td>
							</tr>
							<tr>
										...
										<tr>
											<td colspan="2">Je souhaite devenir : Partenaire  &nbsp; 
												<%if rsProfil("PartenaireMembre")="oui" Then%>
													<input  name="PartenaireProfil" value="oui" type="checkbox" id="PartenaireProfil" checked="checked" />
												<%Else%>
													<input  name="PartenaireProfil" value="non" type="checkbox" id="PartenaireProfil" />
												<%End if%>
											</td>
										</tr>
										<br/><br/>
										...
										<tr>
											...
											<td>
												<%if rsProfil("CooperationMembre")="oui" Then%>
													<input name="CooperationProfil" value="oui" type="checkbox" id="CooperationProfil" checked="checked" />
												<%Else%>
													<input name="CooperationProfil" value="non" type="checkbox" id="CooperationProfil" />
												<%End if%>
											</td>
										</tr>
										<tr>
											...
											<td>
												<%if rsProfil("SolidaireMembre")="oui" Then%>
													<input name="SolidaireProfil" value="oui" type="checkbox" id="SolidaireProfil" checked="checked" />
												<%Else%>
													<input name="SolidaireProfil" value="non" type="checkbox" id="SolidaireProfil" />
												<%End if%>
											</td>
										</tr>
										<tr>
											...
											<td>
												<%if rsProfil("FormationMembre")="oui" Then%>
													<input name="FormationProfil" value="oui" type="checkbox" id="FormationProfil" checked="checked" />
												<%Else%>
													<input name="FormationProfil" value="non" type="checkbox" id="FormationProfil" />
												<%End if%>
											</td>
										</tr>
										<tr>
											...
											<td>
												<%if rsProfil("AutreMembre")="oui" Then%>
													<input name="AutreProfil" value="oui" type="checkbox" id="AutreProfil" checked="checked" />
												<%Else%>
													<input name="AutreProfil" value="non" type="checkbox" id="AutreProfil" />
												<%End if%>
											</td>
										</tr>
									</table>
													...
													<tr>
														...
														<td>
															<%if rsProfil("News")="oui" Then%>
																<input name="NewsProfil" value="oui" type="checkbox" id="NewsProfil" checked="checked" />
															<%Else%>
																<input name="NewsProfil" value="non" type="checkbox" id="NewsProfil" />
															<%End if%>
														</td>
													</tr>
													<tr>
														...
														<td>
															<%if rsProfil("RedacteurMembre")="oui" Then%>
																<input name="RedacteurProfil" value="oui" type="checkbox" id="RedacteurProfil" checked="checked" />
															<%Else%>
																<input name="RedacteurProfil" value="non" type="checkbox" id="RedacteurProfil" />
															<%End if%>
														</td>
													</tr>
													<tr>
														...
														<td>
															<%if rsProfil("InterviewMembre")="oui" Then%>
																<input name="InterviewProfil" value="oui" type="checkbox" id="InterviewProfil" checked="checked" />
															<%Else%>
																<input name="InterviewProfil" value="non" type="checkbox" id="InterviewProfil" />
															<%End if%>
														</td>
													</tr>
													<tr>
														...
														<td>
															<%if rsProfil("CreationsiteMembre")="oui" Then%>
																<input name="CreationsiteProfil" value="oui" type="checkbox" id="CreationsiteProfil" checked="checked" />
															<%Else%>
																<input name="CreationsiteProfil" value="non" type="checkbox" id="CreationsiteProfil" />
															<%End if%>
														</td>
													</tr>
													<tr>
														...
														<td>
															<%if rsProfil("AutresMembre")="oui" Then%>
																<input name="AutresProfil" value="oui" type="checkbox" id="AutresProfil" checked="checked" />
															<%Else%>
																<input name="AutresProfil" value="non" type="checkbox" id="AutresProfil" />
															<%End if%>
														</td>
													</tr>
												</table>
