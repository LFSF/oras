...
'Set rsDI = Conn.Execute("SELECT * FROM ANNONCES,CV,REGIONS WHERE CV.NumCV =" &  Request.QueryString("num") & " AND ANNONCES.NumCV=CV.NumCV AND REGIONS.idRegion=ANNONCES.LieuAnn ;")
Set rsDI = Conn.Execute("SELECT * FROM ANNONCES,CV,REGIONS WHERE CV.NumCV =" &  Request.QueryString("num") & " AND ANNONCES.NumCV=CV.NumCV ;")
...
INSERTION  TABLE FORMULAIRE A MODIFIER
 ...
 'Set rsDI = Conn.Execute("SELECT * FROM ANNONCES,CV,REGIONS where CV.NumCV = "& Request.QueryString("num") &" AND ANNONCES.NumCV=CV.NumCV AND REGIONS.idRegion=ANNONCES.LieuAnn;")
 'Set rsDI = Conn.Execute("SELECT * FROM ANNONCES,CV,REGIONS WHERE CV.NumCV = "& Request.QueryString("num") &" AND ANNONCES.NumCV=CV.NumCV ;")
 Set rsDII = Conn.Execute("SELECT * FROM ANNONCES,REGIONS WHERE NumAnn =76 AND idRegion=CAST(LieuAnn AS varchar);")
 
 response.write "blablablabla blabla" & rsDII("nomRegion")
