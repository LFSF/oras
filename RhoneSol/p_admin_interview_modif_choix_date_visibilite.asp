...
<table border="0px" width="100%" cellpadding="10px">
	...
	<tr>
    	<td colspan="2"><font color="#6faa06">Informations Interview ______________________________________________________</font></td>
    </tr>
				<tr>
				<td width=82%>
...
<table  border="0" align="center" >
 ...
 <br> 
			...
			<tr> 
                    ...
                    <td><% =rsE("titre_interview")%></td>
                  </tr>
				  <tr> 
                    <td class="txt1">Date de l'interview :</td>
                    <td><% =rsE("date_interview")%></td>
                  </tr>
				   <tr> 
                  ...
                  <tr> 
                    ...
                    <td><% =rsE("nom_responsable")%></td>
                  </tr>
				  <tr> 
                    <td class="txt1">Prenom du responsable :</td>
                    <td><% =rsE("prenom_responsable")%></td>
                  </tr>
				  <tr> 
...
<form action="valider_p_admin_interview_modif_choix_date.asp" method="post" id="intw" name="intw">
<tr> 
                    <td colspan="2">
<br/>
<font color="red">Date de parution de l'interview *&nbsp;&nbsp;</font> <input onclick="ds_sh(this);" name="date" readonly="readonly" style="cursor: text" /><br />
</td>
                  </tr>
...
<tr> 
				  ...
				  <tr>
				   ...
				   <br>
 <br> <%session("num")=rsE("num")%>
				  <center>
                   <INPUT style="WIDTH: 153px; HEIGHT: 24px;color:blue;" type=submit size=51 value=Valider id=submit1 name=submit1></center>
