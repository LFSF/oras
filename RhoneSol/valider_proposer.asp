...
End if
 ...
 RS("IntituleOff")=Trim(replace(REPLACE(session("intitule"),"""",espace),"'",simplecot))
 RS("LieuOff")=session("lieu")
 RS("VilleOff")=Trim(replace(REPLACE(session("precision_lieu"),"""",espace),"'",simplecot))
 response.Write(RS("VilleOff"))
 RS("DescOff")=Trim(replace(REPLACE(session("description"),"""",espace),"'",simplecot))
 response.Write(RS("DescOff"))
 RS("DureeOff")=Trim(replace(REPLACE(session("duree_contrat"),"""",espace),"'",simplecot))
