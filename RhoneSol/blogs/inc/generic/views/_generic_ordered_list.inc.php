 ...
 *
 * @version $Id: _generic_ordered_list.inc.php,v 1.3 2008/01/21 09:35:31 fplanque Exp $
 */
...
// Create result set:
$sql = "SELECT $GenericElementCache->dbIDname, {$GenericElementCache->dbprefix}name, {$GenericElementCache->dbprefix}order
