...
function fonc1()
{
window.location.href ='p_admin_actu_insert.asp'
}
function fonc2()
{
window.location.href ='p_admin_actu_modif.asp'
}

function fonc3()
{
window.location.href ='p_admin_actu_visualisation.asp'
}
	...
	<TR>-->
		...
		<td align="middle" bgcolor="white">
			<table width="192" border="0" 
				 style  ="WIDTH: 192px; HEIGHT: 15px">
			<tr>
				<td align="middle"><div class=alien name="Modifier actu ndambog"  title="Modifier actu Ndambog" onclick="return fonc3()">
...
<% else response.Redirect("p_membres.asp")
end if %>