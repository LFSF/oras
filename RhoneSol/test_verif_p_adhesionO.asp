...
valign="center" class="txt2">
	...
	<table width="400" border="0" cellpadding="0" cellspacing="0" class="txt">
				  ...
				  <br>
					<br> 	
					  <INPUT TYPE="BUTTON" style="width:75" VALUE="Modifier" onClick="javascript:redirigeexecute()">
					  <!--INPUT TYPE="BUTTON" style="width:75" VALUE="Modifier" onClick="self.location.href='test_p_adhesion.asp#'" -->
	...
	<% response.write "Type : " & Session("Type") %>
