...
'2. Please include <A Href="http://www.pstruh.cz/help/scptutl/upload.asp">Pure-ASP file upload</A>
' or similar text link to http://www.pstruh.cz on the web site using Pure-ASP upload.
...
'This class emulates ASPForm Class of Huge-ASP upload, http://upload.pstruh.cz
...
Class ASPForm
  ...
  ' if you want to upload bigger files, please register ScriptUtilities and Huge-ASP upload
	' at http://www.pstruh.cz/help/scptutl/lc2.htm
