<%
'Pure-ASP upload v. 2.0 (with progress bar)
...
Const xfsUnknownType  = &HC '12  Unknown source form (Content-type must be application/x-www-form-urlencoded or multipart/form-data) 
...
Class ASPForm
	...
	Public Function getForm(FormID)
		...
		'response.write "pd:" & ProgressData & ",fi:" & FormID
...
'		wscript.echo "**SaveAs", newFileName
