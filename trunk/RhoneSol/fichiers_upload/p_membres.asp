...
if session("admin_nom")<>"" then
  ...
  <p>
              ...
              <input name="loga" class="txt" id="loga" size="30" maxlength="100" /><br>
            
              <font color="green">Mot de passe</font><br />
              <input type="password" name="password" class="txt" id="password" size="30"/><br>
  </p>         
<a align="center"><a href="p_adhesion.asp"> S'inscrire </a><br/>
