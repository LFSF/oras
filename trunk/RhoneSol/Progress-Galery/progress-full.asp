...
Dim Form: Set Form = New ASPForm %><!--#INCLUDE FILE="_upload.asp"--><% 
  ...
  TDsread = replace(space(0.5*PercBytesRead), " ", "<TD BGColor=yellow Class=p> </TD>")
...
<Head>
 ...
 <xMETA HTTP-EQUIV="Refresh" CONTENT="<%=RefreshTime%>">
...
<tr>
 <Th ColSpan=2><Input Type=Button Value="Cancel upload" OnClick="Cancel()" 
 Style="background-color:red;color:white;cursor:hand;font-weight:bold"></Th>
</tr>

<tr>
 <Td ColSpan=2><%=UpStateHTML%></Td>
</tr>
</table>
