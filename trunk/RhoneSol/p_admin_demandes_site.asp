...
function fonc1()
{
window.location.href ='p_admin_demande_site_validation.asp'
}
function fonc2()
{
window.location.href ='p_admin_demande_site_visualisation.asp'
}
  ...
  <TR>
		<td align="middle" bgcolor="white">
            ...
            onclick="return fonc1()">
				Visualisation / Validation des dernieres demandes</div>
				</td>
			</tr>		
			</table>
		</td><!--</tr>
