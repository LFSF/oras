...
var WYSIWYG = {
	...
	insertLink: function(href, target, style, styleClass, name, n) {
		...
		//On attribue un style de lien par defaut pour qu'ils soient differents
		if(styleClass!=""){
			WYSIWYG_Core.setAttribute(lin, "class", styleClass);
			WYSIWYG_Core.setAttribute(lin, "className", styleClass);
		}else{
			WYSIWYG_Core.setAttribute(lin, "class", "link_editor");
			WYSIWYG_Core.setAttribute(lin, "className", "link_editor");
		}
