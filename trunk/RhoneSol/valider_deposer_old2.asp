...
ObjSendMail.HTMLBody = "Bonjour " &  session("civilite") & " " &  session("prenom") & " " & session("nom") &   "<br/><br/>Votre r&eacute;ponse &agrave; l'offre a bien &eacute;t&eacute; prise en compte sur le site www.rhone-solidarite.com .<br/><br/>Merci pour la confiance que vous nous accordez. <br/><br/> Le service des annonces de  Rhone-solidarite.com"
