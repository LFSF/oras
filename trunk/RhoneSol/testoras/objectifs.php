...
<body onload="MM_preloadImages('img/img_r2_c5bis.jpg','img/img_r2_c6bis.jpg','img/img_r2_c7bis.jpg','img/img_r2_c8bis.jpg','img/img_r2_c3bis.jpg')">
...
<div id="conteneur">
	...
	<div id="header">
        ...
        <div id="menu">
       	  <table border="0" cellpadding="0" cellspacing="0">
        	  <tr>
        	    <td><a href="index.php" target="_top" onclick="MM_nbGroup('down','group1','accueil','',1)" onmouseover="MM_nbGroup('over','accueil','img/img_r2_c3bis.jpg','',1)" onmouseout="MM_nbGroup('out')"><img src="img/img_r2_c3.jpg" alt="" name="accueil" border="0" id="accueil" /></a></td>
        	    <td><a href="javascript:;" target="_top" onclick="MM_nbGroup('down','group1','objectifs','',1)" onmouseover="MM_nbGroup('over','objectifs','','',1)" onmouseout="MM_nbGroup('out')"><img src="img/img_r2_c4bis.jpg" alt="image" name="objectifs" border="0" id="objectifs" /></a></td>
        	    <td><a href="missions.php" target="_top" onclick="MM_nbGroup('down','group1','missions','',1)" onmouseover="MM_nbGroup('over','missions','img/img_r2_c5bis.jpg','',1)" onmouseout="MM_nbGroup('out')"><img src="img/img_r2_c5.jpg" alt="image" name="missions" width="115" height="38" border="0" id="missions" /></a></td>
	...
	<div id="etiquettes">
        	...
        	<img src="img/etiquettes/charte.gif" alt="image" />
...
<p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
	...
	<div style="position:absolute; left:805px; z-index:100; top:340px;"> <!-- En fonction de la longueur du contenu précédent, modifier la valeur "top:340px" -->
    
        	<img src="img/etiquettes/objectifs.gif" alt="image" />
